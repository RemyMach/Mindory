...
exports.ShotPartTwoFixture = void 0;
...
var ShotPartTwoFixture = /** @class */ (function () {
    function ShotPartTwoFixture() {
    }
    ShotPartTwoFixture.getInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (ShotPartTwoFixture.instance === undefined) {
                    ShotPartTwoFixture.instance = new ShotPartTwoFixture();
                }
                return [2 /*return*/, ShotPartTwoFixture.instance];
            });
        });
    };
    ;
    ShotPartTwoFixture.prototype.fillTable = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ShotPartTwoFixture.prototype.destroyFieldsTable = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var manager;
    ...
    return ShotPartTwoFixture;
}());
exports.ShotPartTwoFixture = ShotPartTwoFixture;
