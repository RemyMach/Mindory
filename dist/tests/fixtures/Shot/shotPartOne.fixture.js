...
exports.ShotPartOneFixture = void 0;
...
var ShotPartOneFixture = /** @class */ (function () {
    function ShotPartOneFixture() {
    }
    ShotPartOneFixture.getInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (ShotPartOneFixture.instance === undefined) {
                    ShotPartOneFixture.instance = new ShotPartOneFixture();
                }
                return [2 /*return*/, ShotPartOneFixture.instance];
            });
        });
    };
    ;
    ShotPartOneFixture.prototype.fillTable = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ShotPartOneFixture.prototype.destroyFieldsTable = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var manager;
    ...
    return ShotPartOneFixture;
}());
exports.ShotPartOneFixture = ShotPartOneFixture;
