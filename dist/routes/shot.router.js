...
var shot_controller_1 = require("../controllers/shot.controller");
var shotRouter = express_1.default.Router();
exports.shotRouter = shotRouter;
shotRouter.post("/", [
    ...
    return __awaiter(this, void 0, void 0, function () {
        var errors, userController, user, _a, cardIds, partId, time, shotController, part, userIsInThePart, shot, partController, thePartIsEnd;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _a = req.body, cardIds = _a.cardIds, partId = _a.partId, time = _a.time;
                    return [4 /*yield*/, shot_controller_1.ShotController.getInstance()];
                case 3:
                    shotController = _b.sent();
                    return [4 /*yield*/, shotController.part.findByPk(partId)];
                case 4:
                    part = _b.sent();
                    if (part === null)
                        throw new basicError_1.default("The part doesn't exist");
                    return [4 /*yield*/, shotController.verifyIfUserIsInThePart(user, part)];
                case 5:
                    userIsInThePart = _b.sent();
                    if (!userIsInThePart)
                        throw new basicError_1.default("The user is not in the part");
                    return [4 /*yield*/, shotController.createShot(part, user, cardIds, time)];
                case 6:
                    shot = _b.sent();
                    return [4 /*yield*/, part_controller_1.PartController.getInstance()];
                case 7:
                    partController = _b.sent();
                    return [4 /*yield*/, partController.partIsEnd(part)];
                case 8:
                    thePartIsEnd = _b.sent();
                    if (!thePartIsEnd) return [3 /*break*/, 10];
                    return [4 /*yield*/, partController.registerTheEndOfThePart(part, time)];
                case 9:
                    _b.sent();
                    _b.label = 10;
                case 10: return [2 /*return*/, res.status(200).json(shot).end()];
            }
        });
    });
});
